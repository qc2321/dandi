    ...
    return (
        ...
        `}
            >
                ...
                {/* Logo */}
                <div className={`flex items-center gap-2 mb-8 transition-all duration-300 ${sidebarOpen ? "" : "justify-center"}`}>
                ...
                <nav className={`flex-1 flex flex-col gap-1 text-sm ${sidebarOpen ? "" : "items-center"}`}>
                    <Link href="/dashboards" className={`flex items-center gap-2 px-3 py-2 rounded-lg font-semibold text-gray-900 bg-gray-100 ${sidebarOpen ? "justify-start" : "justify-center"}`}>
